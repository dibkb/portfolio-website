...
- [PypI Page Amazon Scraper](https://pypi.org/project/dibkb-scraper/)
...
- `LLaMA-4 Maverick` — Local LLM for sentiment analysis, product enhancement, and copy generation
- `GPT-4o` — Context-rich reasoning and fallback for complex queries
- `LangChain` — LLM orchestration, agent routing, and prompt management

### 🧰 Frameworks & SDKs

- `FastAPI` — High-performance Python backend for APIs
- `Next.js` — React-based frontend framework for dynamic UI
- `Drizzle ORM` — Type-safe ORM for interacting with PostgreSQL
- `Zod` — Schema validation for forms and API data
- `Zustand` — Lightweight state management in the frontend
- `Pigeon Maps` — IP tracking and geolocation mapping
- `BeautifulSoup + Playwright` — Headless scraping and DOM parsing engine

### 💻 Code & UI

- `ShadCN UI` — Accessible and elegant UI components
- `Tailwind CSS` — Utility-first styling for consistent design
- `Monaco Editor` _(coming soon)_ — Rich text/code editing for custom copy tweaks

### ☁️ Storage & Infrastructure

- `PostgreSQL` — Relational database for persistent storage
- `Amazon EC2` — Cloud instance for hosting the backend services
- `Docker` — Containerized deployments for portability
- `Nginx` — Reverse proxy and server manager

### 🚀 CI/CD & Deployment

- `GitLab CI` — Automated testing and deployment pipelines
- `AWS EC2` — Hosting the FastAPI backend with Docker
- `Nginx` — Serving static frontend & proxying backend endpoints
